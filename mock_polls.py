...
from server.models import User, Post, Poll, PollOption
...
mock_data = [
    ...
    {"question": "Your ultimate comfort food during finals week?", "options": ["Maggi", "Cold Coffee & Pastry", "Pizza Delivery", "Just water and tears"]}
]

with app.app_context():
    oracle = User.query.filter_by(username='system_oracle').first() or User.query.first()
